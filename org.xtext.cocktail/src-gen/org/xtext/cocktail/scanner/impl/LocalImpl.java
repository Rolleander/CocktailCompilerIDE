 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.cocktail.scanner.impl.LocalImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocalImpl extends MinimalEObjectImpl.Container implements Local
{
  ...
  {
    return ScannerPackage.Literals.LOCAL;
  }
  ...
  public void setContent(String newContent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScannerPackage.LOCAL__CONTENT, oldContent, content));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScannerPackage.LOCAL__CONTENT:
        return getContent();
    }
