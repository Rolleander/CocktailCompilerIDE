 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.cocktail.scanner.impl.DefaultImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultImpl extends MinimalEObjectImpl.Container implements Default
{
  ...
  {
    return ScannerPackage.Literals.DEFAULT;
  }
  ...
  public void setContent(String newContent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScannerPackage.DEFAULT__CONTENT, oldContent, content));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ScannerPackage.DEFAULT__CONTENT:
        return getContent();
    }
