...
public class PropertyListImpl extends MinimalEObjectImpl.Container implements PropertyList
{
  ...
  {
    return AstPackage.Literals.PROPERTY_LIST;
  }
  ...
  public EList<String> getProps()
  {
    if (props == null)
    {
      props = new EDataTypeEList<String>(String.class, this, AstPackage.PROPERTY_LIST__PROPS);
    }
    return props;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AstPackage.PROPERTY_LIST__PROPS:
        return getProps();
    }
