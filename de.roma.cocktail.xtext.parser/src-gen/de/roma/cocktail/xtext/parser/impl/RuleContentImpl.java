 ...
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.parser.impl.RuleContentImpl#getRegex <em>Regex</em>}</li>
 *   <li>{@link de.roma.cocktail.xtext.parser.impl.RuleContentImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleContentImpl extends MinimalEObjectImpl.Container implements RuleContent
{
  ...
  {
    return ParserPackage.Literals.RULE_CONTENT;
  }
  ...
  public void setRegex(String newRegex)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.RULE_CONTENT__REGEX, oldRegex, regex));
  }
  ...
  public GrammerReference getRef()
  {
    if (ref != null && ref.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParserPackage.RULE_CONTENT__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(GrammerReference newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ParserPackage.RULE_CONTENT__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ParserPackage.RULE_CONTENT__REGEX:
        return getRegex();
      case ParserPackage.RULE_CONTENT__REF:
