 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.parser.impl.StartSymbolsImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartSymbolsImpl extends MinimalEObjectImpl.Container implements StartSymbols
{
  ...
  {
    return ParserPackage.Literals.START_SYMBOLS;
  }
  ...
  public EList<StartState> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<StartState>(StartState.class, this, ParserPackage.START_SYMBOLS__STATES);
    }
    return states;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ParserPackage.START_SYMBOLS__STATES:
