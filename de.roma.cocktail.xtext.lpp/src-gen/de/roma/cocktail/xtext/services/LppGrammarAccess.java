...
public class LppGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ParserModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.ParserModel");
	...
	public class TokensElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.Tokens");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GrammerReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.GrammerReference");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class SimpleRuleElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRulesSimpleRuleParserRuleCall_3_1_0 = (RuleCall)cRulesAssignment_3_1.eContents().get(0);
		private final Keyword cGreaterThanSignFullStopKeyword_3_2 = (Keyword)cGroup_3.eContents().get(2);
		...
		//SimpleRule
		public RuleCall getRulesSimpleRuleParserRuleCall_3_1_0() { return cRulesSimpleRuleParserRuleCall_3_1_0; }
		
		//'>.'
		public Keyword getGreaterThanSignFullStopKeyword_3_2() { return cGreaterThanSignFullStopKeyword_3_2; }
	}
	...
	public class RuleCodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.RuleCode");
	...
	public class RuleContentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.RuleContent");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class RulePartElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.roma.cocktail.xtext.Lpp.RulePart");
	...
	private final SimpleRuleElements pSimpleRule;
	...
	public LppGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pSimpleRule = new SimpleRuleElements();
	...
	//SimpleRule:
	//	name=ID? '=' body=RuleBody ('<' rules+=SimpleRule* '>.')?;
	public SimpleRuleElements getSimpleRuleAccess() {
		return pSimpleRule;
	}
	
	public ParserRule getSimpleRuleRule() {
		return getSimpleRuleAccess().getRule();
	}
