...
public interface LppPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTENSION_RULE_FEATURE_COUNT = 2;
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.roma.cocktail.xtext.lpp.GrammarRule#getBody <em>Body</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Body</em>'.
   * @see de.roma.cocktail.xtext.lpp.GrammarRule#getBody()
   * @see #getGrammarRule()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link de.roma.cocktail.xtext.lpp.ExtensionRule#getBody <em>Body</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Body</em>'.
   * @see de.roma.cocktail.xtext.lpp.ExtensionRule#getBody()
   * @see #getExtensionRule()
   * @generated
   */
  EReference getExtensionRule_Body();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.roma.cocktail.xtext.lpp.RuleBody#getNodetype <em>Nodetype</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Nodetype</em>'.
   * @see de.roma.cocktail.xtext.lpp.RuleBody#getNodetype()
   * @see #getRuleBody()
   * @generated
   */
  EAttribute getRuleBody_Nodetype();

  /**
   * Returns the meta object for the containment reference list '{@link de.roma.cocktail.xtext.lpp.RuleBody#getPart <em>Part</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the reference '{@link de.roma.cocktail.xtext.lpp.RuleBody#getToken <em>Token</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Token</em>'.
   * @see de.roma.cocktail.xtext.lpp.RuleBody#getToken()
   * @see #getRuleBody()
   * @generated
   */
  EReference getRuleBody_Token();

  /**
   * Returns the meta object for the containment reference '{@link de.roma.cocktail.xtext.lpp.RuleBody#getBlock <em>Block</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Block</em>'.
   * @see de.roma.cocktail.xtext.lpp.RuleBody#getBlock()
   * @see #getRuleBody()
   * @generated
   */
  EReference getRuleBody_Block();

  /**
   * Returns the meta object for the containment reference '{@link de.roma.cocktail.xtext.lpp.RuleBody#getExtension <em>Extension</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Extension</em>'.
   * @see de.roma.cocktail.xtext.lpp.RuleBody#getExtension()
   * @see #getRuleBody()
   * @generated
   */
  EReference getRuleBody_Extension();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference EXTENSION_RULE__BODY = eINSTANCE.getExtensionRule_Body();
     ...
     * @generated
     */
    EAttribute RULE_BODY__NODETYPE = eINSTANCE.getRuleBody_Nodetype();
     ...
     * @generated
     */
    EReference RULE_BODY__TOKEN = eINSTANCE.getRuleBody_Token();
     ...
     * @generated
     */
    EReference RULE_BODY__BLOCK = eINSTANCE.getRuleBody_Block();
     ...
     * @generated
     */
    EReference RULE_BODY__EXTENSION = eINSTANCE.getRuleBody_Extension();
