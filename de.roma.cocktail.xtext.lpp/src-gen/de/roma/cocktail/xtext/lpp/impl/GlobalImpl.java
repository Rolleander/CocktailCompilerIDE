 ...
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.lpp.impl.GlobalImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalImpl extends MinimalEObjectImpl.Container implements Global
{
  ...
  {
    return LppPackage.Literals.GLOBAL;
  }
  ...
  public NotificationChain basicSetContent(CodeBlock newContent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LppPackage.GLOBAL__CONTENT, oldContent, newContent);
  ...
  public void setContent(CodeBlock newContent)
  {
    if (newContent != content)
    {
      ...
      if (content != null)
        msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LppPackage.GLOBAL__CONTENT, null, msgs);
      if (newContent != null)
        msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LppPackage.GLOBAL__CONTENT, null, msgs);
      msgs = basicSetContent(newContent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LppPackage.GLOBAL__CONTENT, newContent, newContent));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LppPackage.GLOBAL__CONTENT:
