 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.lpp.impl.ExportImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportImpl extends MinimalEObjectImpl.Container implements Export
{
  ...
  {
    return LppPackage.Literals.EXPORT;
  }
  ...
  public NotificationChain basicSetContent(CodeBlock newContent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LppPackage.EXPORT__CONTENT, oldContent, newContent);
  ...
  public void setContent(CodeBlock newContent)
  {
    if (newContent != content)
    {
      ...
      if (content != null)
        msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LppPackage.EXPORT__CONTENT, null, msgs);
      if (newContent != null)
        msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LppPackage.EXPORT__CONTENT, null, msgs);
      msgs = basicSetContent(newContent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LppPackage.EXPORT__CONTENT, newContent, newContent));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LppPackage.EXPORT__CONTENT:
