 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.lpp.impl.GrammarRulesImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GrammarRulesImpl extends MinimalEObjectImpl.Container implements GrammarRules
{
  ...
  public EList<GrammarRule> getRules()
  {
    if (rules == null)
    {
      rules = new EObjectContainmentEList<GrammarRule>(GrammarRule.class, this, LppPackage.GRAMMAR_RULES__RULES);
    }
    return rules;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LppPackage.GRAMMAR_RULES__RULES:
