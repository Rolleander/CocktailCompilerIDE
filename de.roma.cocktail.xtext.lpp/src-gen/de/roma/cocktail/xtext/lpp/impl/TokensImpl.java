 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.lpp.impl.TokensImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokensImpl extends MinimalEObjectImpl.Container implements Tokens
{
  ...
  {
    return LppPackage.Literals.TOKENS;
  }
  ...
  public EList<DefinedToken> getTokens()
  {
    if (tokens == null)
    {
      tokens = new EObjectContainmentEList<DefinedToken>(DefinedToken.class, this, LppPackage.TOKENS__TOKENS);
    }
    return tokens;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LppPackage.TOKENS__TOKENS:
