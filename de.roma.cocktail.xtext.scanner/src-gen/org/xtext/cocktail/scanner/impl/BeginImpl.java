...
public class BeginImpl extends MinimalEObjectImpl.Container implements Begin
{
  ...
  public NotificationChain basicSetContent(CodeBlock newContent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ScannerPackage.BEGIN__CONTENT, oldContent, newContent);
  ...
  public void setContent(CodeBlock newContent)
  {
    if (newContent != content)
    {
      ...
      if (content != null)
        msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScannerPackage.BEGIN__CONTENT, null, msgs);
      if (newContent != null)
        msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScannerPackage.BEGIN__CONTENT, null, msgs);
      msgs = basicSetContent(newContent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScannerPackage.BEGIN__CONTENT, newContent, newContent));
  }
