		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGrammarRuleAccess().getGroup_4(), "rule__GrammarRule__Group_4__0");
					put(grammarAccess.getExtensionRuleAccess().getGroup(), "rule__ExtensionRule__Group__0");
					put(grammarAccess.getExtensionRuleAccess().getGroup_3(), "rule__ExtensionRule__Group_3__0");
					put(grammarAccess.getExtensionRuleAccess().getGroup_4(), "rule__ExtensionRule__Group_4__0");
					...
					put(grammarAccess.getGrammarRuleAccess().getNodetypeAssignment_1(), "rule__GrammarRule__NodetypeAssignment_1");
					put(grammarAccess.getGrammarRuleAccess().getPartAssignment_2(), "rule__GrammarRule__PartAssignment_2");
					put(grammarAccess.getGrammarRuleAccess().getTokenAssignment_3_1(), "rule__GrammarRule__TokenAssignment_3_1");
					put(grammarAccess.getGrammarRuleAccess().getBlockAssignment_4_1(), "rule__GrammarRule__BlockAssignment_4_1");
					put(grammarAccess.getGrammarRuleAccess().getExtensionAssignment_5(), "rule__GrammarRule__ExtensionAssignment_5");
					put(grammarAccess.getExtensionRuleAccess().getNameAssignment_0(), "rule__ExtensionRule__NameAssignment_0");
					put(grammarAccess.getExtensionRuleAccess().getNodetypeAssignment_1(), "rule__ExtensionRule__NodetypeAssignment_1");
					put(grammarAccess.getExtensionRuleAccess().getPartAssignment_2(), "rule__ExtensionRule__PartAssignment_2");
					put(grammarAccess.getExtensionRuleAccess().getTokenAssignment_3_1(), "rule__ExtensionRule__TokenAssignment_3_1");
					put(grammarAccess.getExtensionRuleAccess().getBlockAssignment_4_1(), "rule__ExtensionRule__BlockAssignment_4_1");
					put(grammarAccess.getExtensionRuleAccess().getExtensionAssignment_5(), "rule__ExtensionRule__ExtensionAssignment_5");
