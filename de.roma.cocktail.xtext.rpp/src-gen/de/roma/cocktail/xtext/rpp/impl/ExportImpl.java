 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.rpp.impl.ExportImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportImpl extends MinimalEObjectImpl.Container implements Export
{
  ...
  {
    return RppPackage.Literals.EXPORT;
  }
  ...
  public NotificationChain basicSetContent(CodeBlock newContent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RppPackage.EXPORT__CONTENT, oldContent, newContent);
  ...
  public void setContent(CodeBlock newContent)
  {
    if (newContent != content)
    {
      ...
      if (content != null)
        msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RppPackage.EXPORT__CONTENT, null, msgs);
      if (newContent != null)
        msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RppPackage.EXPORT__CONTENT, null, msgs);
      msgs = basicSetContent(newContent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RppPackage.EXPORT__CONTENT, newContent, newContent));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RppPackage.EXPORT__CONTENT:
