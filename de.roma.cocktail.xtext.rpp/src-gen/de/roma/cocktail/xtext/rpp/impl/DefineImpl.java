 ...
 * </p>
 * <ul>
 *   <li>{@link de.roma.cocktail.xtext.rpp.impl.DefineImpl#getDefines <em>Defines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefineImpl extends MinimalEObjectImpl.Container implements Define
{
  ...
  {
    return RppPackage.Literals.DEFINE;
  }
  ...
  public EList<DefineRule> getDefines()
  {
    if (defines == null)
    {
      defines = new EObjectContainmentEList<DefineRule>(DefineRule.class, this, RppPackage.DEFINE__DEFINES);
    }
    return defines;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RppPackage.DEFINE__DEFINES:
